...
function getHTML(data, i) {
	var img = "http://sayamkanwar.me/AgGro/adminpanel/images/" + data.image;
	...
	return (
		...
		i +
		'" ><div class="centered">  <img src="http://sayamkanwar.me/AgGro/app/cart.png" class="cart-buttonx" id="idx' +
		i +
...
$(document).ready(function() {
	...
	initFilters();
	$.ajax({
		url: "http://sayamkanwar.me/AgGro/adminpanel/scripts/getDishData.php",
